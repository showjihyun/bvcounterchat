...
| 19c | **RQ-03 정원 10+10 (초과 시 관전자/거부)** | RQ-03, RQ-41 일부, ADR-0002 | 🔄 | `feat/RQ-03-capacity` 브랜치 | **착수(2026-07-22)**. GA-02(11번째→관전자)·GA-21(21번째→거부). 스코프 주의: GA-02의 "월드에 물리적으로 존재하지 않는다"는 물리(4단계) 도입 전이라 현 시점 관측 가능 범위는 "players 컬렉션 비포함 + 관전자 구분"까지 — 물리적 부재 검증은 4단계로 이월 예정 |
